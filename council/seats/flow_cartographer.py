...
your confidence for this staleness, more so over the short term than the
long term. Short interest and days-to-cover are comparatively fresher and can
...
class FlowCartographerSeat:
    ...
    async def deliberate(
        ...
        user_prompt = (
            f"Institutional ownership. Quarter end {s.quarter_end}, "
            ...
            "Discount for the 13F lag and give your lean for each term."
        )
